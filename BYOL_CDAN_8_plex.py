...
dir_data_2025 = os.path.join(PROJECT_DIR, '8_plex')
dir_out = os.path.join(PROJECT_DIR, '8_plex_output')
PRETRAINED_BYOL_CHECKPOINT = os.path.join(PROJECT_DIR, "output", "4.3.8_plex_best_byol_qPCR.pth")
